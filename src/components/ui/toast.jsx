...
const ToastProvider = React.forwardRef((/** @type {any} */ { children, ...props }, ref) => (
    <div
        ref={ref}
...
/** @type {React.ForwardRefExoticComponent<any>} */
const ToastTitle = React.forwardRef((/** @type {any} */ { className, children, ...props }, ref) => (
    <div
        ref={ref}
...
/** @type {React.ForwardRefExoticComponent<any>} */
const ToastDescription = React.forwardRef((/** @type {any} */ { className, children, ...props }, ref) => (
    <div
        ref={ref}
